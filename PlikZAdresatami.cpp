...
{
    //cout << "idZalogowanegoUzytkownika w PlikZAdresatami.cpp - wczytywanie Adresatow z pliku1: " << idZalogowanegoUzytkownika << endl;
    Adresat adresat;
    //idZalogowanegoUzytkownika = adresat.pobierzIdUzytkownika();
    //cout << "idZalogowanegoUzytkownika w PlikZAdresatami.cpp - wczytywanie Adresatow z pliku2: " << idZalogowanegoUzytkownika << endl;
